...
//#endregion
//#region src/extensions/debug/types/RpcDebugTrace.d.ts
type TracingOptions = {
  tracer: 'callTracer';
  tracerConfig?: {
    onlyTopCall?: boolean;
...
type DebugTraceCallOptions = {
  ...
  gas?: Hex | bigint | number; /** The integer of the gasPrice used for each paid gas */
  gasPrice?: Hex | bigint | number; /** The integer of the value sent with this transaction */
  value?: Hex | bigint | number; /** The hash of the method signature and encoded parameters */
  data?: Hex;
};
...
//#endregion
export { BlockReference, type DebugCall, DebugCallType, type DebugTraceBlockHash, type DebugTraceBlockNumber, type DebugTraceCall, type DebugTraceCallOptions, type DebugTraceTransaction, type EthBalance, type EthBlockNumber, type EthBlockReceipts, type EthCode, type EthGetBlockByNumber, type EthGetLogs, type EthGetStorageAt, type EthTransaction, type EthTransactionReceipt, type SuicideAction, type TraceAction, TraceCallType, type TraceFilterParams, type TraceFilterResult, TraceType, type TracingOptions, createDebugRpcCalls, createTraceRpcCalls, setupCustomRpcCalls };
